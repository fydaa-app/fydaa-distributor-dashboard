...
export default function ArnPortfolioSummaryTable({
  ...
  return (
    <div className="rounded-[16px] border border-[var(--arn-bdr)] bg-[var(--arn-bg)] p-5 sm:p-6">
      <ArnCardHeader title="Portfolio summary — all clients">
        <button
          type="button"
          onClick={onExport}
          disabled={isExporting}
          className="inline-flex items-center gap-1.5 text-xs font-semibold text-[var(--arn-amber)] transition-opacity hover:opacity-80 disabled:opacity-50"
        >
