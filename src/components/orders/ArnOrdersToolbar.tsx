import type { ArnOrderSortKey } from "@/types/arnOrders";
...
interface ArnOrdersToolbarProps {
  ...
  view: "table" | "list";
  onSortKeyChange: (value: ArnOrderSortKey) => void;
  onSortDirectionChange: (value: "asc" | "desc") => void;
  onViewChange: (value: "table" | "list") => void;
  onRefresh: () => void;
}

const sortOptions: Array<{ label: string; value: ArnOrderSortKey }> = [
  ...
  return (
    <div className="grid gap-3 lg:grid-cols-[1fr_auto_auto] lg:items-center">
      ...
      <div className="flex items-center gap-2">
        <select
          value={sortKey}
          onChange={(event) => onSortKeyChange(event.target.value as ArnOrderSortKey)}
